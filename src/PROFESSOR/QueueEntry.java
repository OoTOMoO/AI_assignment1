...
/**
 * A class representing a single entry in a search queue; this includes all
 * information likely to be relevant to the search.
 * 
 * Also, the default comparator for this class compares based on the total value
 * of the cost so far and the heuristic - this means that a PriorityQueue-based
 * implementation of A* will function naturally.
 * 
 * @author lackofcheese
 */
public class QueueEntry<Data> implements Comparable<QueueEntry<Data>> {
	...
	/**
	 * If applicable, this holds any additional data needed for specific search
	 * algorithms to function more conveniently.
	 */
	private Data data;
	 ...
	 *            an estimate of the cost to the goal; this should be zero if no
	 *            heuristic is used.
	 * @param data
	 *            if applicable, any additional data required.
	 */
	public QueueEntry(State s, State pred, int depth, double totalCost,
