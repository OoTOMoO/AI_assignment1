...
public class LineIterator implements Iterator<Point2D> {
	final static double DEFAULT_PRECISION = 0.01;
	final Line2D line;
	...
	public LineIterator(Line2D line, double precision) {
		...
		sx = line.getX1() < line.getX2() ? precision : -0.1 * precision;
		sy = line.getY1() < line.getY2() ? precision : -0.1 * precision;
	...
	public boolean hasNext() {
	    return Math.abs( x - line.getX2()) > 0.09 || ( Math.abs(y - line.getY2()) > 0.09);
	}
